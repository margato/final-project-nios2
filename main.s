...
COMMAND_20:
    ...
    mov r9, r0                      # limpa display

    LOAD_2021_IN_DISPLAY:
    stwio r8, HEX3to0(r5)               # carrega 2021 no hex
    stwio r9, HEX7to4(r5)               # carrega 2021 no hex
...
TURN_OFF_2021_ROTATION:
    ...
    movia r9, SEGMENT_DISPLAY_STATE            # carrega em r10 o endereço de memória de SEGMENT_DISPLAY_STATE
    ldw r8, (r9)                               # carrega estado atual
    movi r8, 0b0                               # inverte bit de rotação
    stw r8, (r9)

    stwio r0, HEX3to0(r5)                      # limpa display
    stwio r0, HEX7to4(r5)                      # limpa display


_END_TURN_OFF_2021_ROTATION:
    # epílogo
    ldw ra, (sp)
    ldw r8, 4(sp)
    ldw r9, 8(sp)
...
HANDLE_INTERRUPTION_2021: 
    ...
    ldwio r11, HEX7to4(r5)                            # carrega valor atual de 2021 na memória HEX7-4
    ldwio r9, HEX3to0(r5)                             # carrega valor atual de 2021 na memória HEX3-0
    movi r10, 8                                     
    # 0: left, 1: right 
    ...
    _LOAD_2021:
        ...
        stwio r11, HEX7to4(r5)                      # carrega 2021 atual no display
...
COMMAND_10:
    ...
    call TURN_OFF_2021_ROTATION # desligar 2021
